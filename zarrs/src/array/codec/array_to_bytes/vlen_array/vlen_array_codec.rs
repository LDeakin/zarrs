...
/// The `vlen-array` codec implementation.
#[derive(Debug, Clone)]
pub struct VlenArrayCodec {
    inner: Arc<VlenV2Codec>,
}

impl VlenArrayCodec {
    /// Create a new `vlen-array` codec.
    #[must_use]
    pub fn new() -> Self {
        Self {
            inner: Arc::new(VlenV2Codec::new("vlen-array".to_string())),
        }
    }
}

impl Default for VlenArrayCodec {
    fn default() -> Self {
        Self::new()
    }
}

impl CodecTraits for VlenArrayCodec {
