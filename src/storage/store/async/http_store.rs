...
mod tests {
    ...
    //     let store = AsyncHTTPStore::new(HTTP_TEST_PATH_REF).unwrap();
    //     let array = Array::new(store.into(), ARRAY_PATH_REF).await.unwrap();
    ...
    //     let array = Array::new(store.into(), ARRAY_PATH).await.unwrap();
    ...
    //     let array = Array::new(store.into(), ARRAY_PATH_SHARDED).await.unwrap();
