...
pub fn codec_metadata_v2_to_v3(
    ...
    if let Some(filters) = filters {
        for filter in filters {
            ...
            let name = codec_aliases_v3.default_name(identifier);
            match identifier {
...
pub fn array_metadata_v2_to_v3(
    ...
    codec_aliases_v2: &ExtensionAliasesCodecV2,
    codec_aliases_v3: &ExtensionAliasesCodecV3,
    data_type_aliases: &ExtensionAliasesDataTypeV2,
    ...
    let (Ok(data_type), endianness) = (
        data_type_metadata_v2_to_v3_data_type(&array_metadata_v2.dtype, data_type_aliases),
...
pub fn data_type_metadata_v2_to_v3_data_type(
    ...
    match data_type {
        DataTypeMetadataV2::Simple(name) => {
            ...
            let name = data_type_aliases.default_name(identifier);
